...
using prezentacjaxaf.Blazor.Server.Services;

namespace prezentacjaxaf.Blazor.Server {
    public partial class prezentacjaxafBlazorApplication : BlazorApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static prezentacjaxafBlazorApplication() {
            DevExpress.Persistent.Base.PasswordCryptographer.EnableRfc2898 = true;
            DevExpress.Persistent.Base.PasswordCryptographer.SupportLegacySha512 = false;
            DevExpress.ExpressApp.BaseObjectSpace.ThrowExceptionForNotRegisteredEntityType = true;
        }
        #endregion
        public prezentacjaxafBlazorApplication() {
            InitializeComponent();
            SetupAuthentication();
        ...
        private void prezentacjaxafBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
